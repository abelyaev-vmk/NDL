...
python3 videomodul.py --create-images --path=${VIDEO_NAME} --out=${IMAGES_DIR}
echo "Start CNN"
...
echo "Creating video"
python3 videomodul.py --create-video --path=${IMAGES_DIR} --marking=${VIDEOSET} --out=result_video.avi