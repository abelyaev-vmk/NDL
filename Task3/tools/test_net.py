...
# Modified by Konstantin Sofiyuk  & Andrey Belyaev
# --------------------------------------------------------
...
def parse_args():
    ...
    parser.add_argument('--proto', dest='proto', help='proto to model', default=None, type=str)
...
if __name__ == '__main__':
    ...
    if args.proto is not None:
        cfg.MODEL.PRETRAINED_MODEL_CONFIG = args.proto
